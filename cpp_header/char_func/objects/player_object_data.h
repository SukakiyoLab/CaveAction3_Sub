...
inline XMLData* player_object_data(){
	XMLData* next_storage_0 = new XMLData(std::string(""));
	next_storage_0->tag = "root";
	XMLData* next_storage_1 = new XMLData(std::string("player"));
	...
	XMLData* next_storage_18 = new XMLData(std::string("player_anim_data"));
	...
	XMLData* next_storage_32 = new XMLData(std::string("1.0"));
	next_storage_32->tag = "mass";
	next_storage_30->nexts["mass"].push_back(next_storage_32);
	XMLData* next_storage_33 = new XMLData(std::string("0.5"));
	...
	XMLData* next_storage_49 = new XMLData(std::string("32.0"));
	next_storage_49->tag = "w";
	next_storage_45->nexts["w"].push_back(next_storage_49);
	XMLData* next_storage_50 = new XMLData(std::string("32.0"));
	...
	next_storage_56->tag = "player_controller";
	XMLData* next_storage_57 = new XMLData(std::string("0"));
	next_storage_57->tag = "rigidbody_id";
	next_storage_56->nexts["rigidbody_id"].push_back(next_storage_57);
	XMLData* next_storage_58 = new XMLData(std::string("0"));
	next_storage_58->tag = "virtual_controller_id";
	next_storage_56->nexts["virtual_controller_id"].push_back(next_storage_58);
	XMLData* next_storage_59 = new XMLData(std::string("0"));
	next_storage_59->tag = "animator2D_id";
	next_storage_56->nexts["animator2D_id"].push_back(next_storage_59);
	next_storage_55->nexts["player_controller"].push_back(next_storage_56);
	next_storage_0->nexts["component"].push_back(next_storage_55);
	XMLData* next_storage_60 = new XMLData(std::string(""));
	next_storage_60->tag = "other_object_components";
	next_storage_0->nexts["other_object_components"].push_back(next_storage_60);
