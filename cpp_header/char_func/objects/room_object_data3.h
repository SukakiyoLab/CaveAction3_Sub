...
inline XMLData* room_object_data3(){
	XMLData* next_storage_0 = new XMLData(std::string(""));
	next_storage_0->tag = "root";
	XMLData* next_storage_1 = new XMLData(std::string("Room3"));
	...
	XMLData* next_storage_19 = new XMLData(std::string("tilemap_data_3_1"));
	...
	XMLData* next_storage_28 = new XMLData(std::string("tilemap_data_3_2"));
	...
	XMLData* next_storage_37 = new XMLData(std::string("tilemap_data_3_3"));
	...
	XMLData* next_storage_49 = new XMLData(std::string("tilemap_data_3_collider"));
